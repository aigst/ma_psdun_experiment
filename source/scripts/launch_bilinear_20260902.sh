...
OUT="$ROOT/new_results_20260902_bilinear"
mkdir -p "$OUT"
...
run_one 0 bilinear_s12_p050 12 0.50
run_one 1 bilinear_s08_p050 8 0.50
run_one 2 bilinear_s06_p050 6 0.50
run_one 3 bilinear_s12_p030 12 0.30
wait
