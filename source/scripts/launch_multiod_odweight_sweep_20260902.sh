...
OUT="$ROOT/new_results_20260902_multiod_odweight"
mkdir -p "$OUT"
...
run_one 0 odw_60251005 0.60,0.25,0.10,0.05 20260950
run_one 1 odw_70200802 0.70,0.20,0.08,0.02 20260951
run_one 2 odw_50301502 0.50,0.30,0.15,0.05 20260952
run_one 3 odw_10000000 1.00,0.00,0.00,0.00 20260953
wait
