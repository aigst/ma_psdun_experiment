...
OUT=${MA_PSDUN_PSF_FINAL_OUT:-$ROOT/results_psf_sigma1_final_20260904}
...
common=(
  ...
  --preprocess detrend --detrend-width 127 --fusion mean --psf-sigma 1.0
...
run_final 0 20261671
run_final 1 20261672
run_final 2 20261673
run_final 3 20261674
wait

members=$OUT/final/seed20261671,$OUT/final/seed20261672,$OUT/final/seed20261673,$OUT/final/seed20261674
CUDA_VISIBLE_DEVICES="" OMP_NUM_THREADS=1 MKL_NUM_THREADS=1 \
  "$PYTHON" "$SRC/ring_blind_train.py" \
    --mode ensemble --exp-dir "$OUT/final/ensemble" --members "$members"

selection_dirs=$ROOT/results_psf_sigma_cv_20260904/sigma_1p0/selection/fold1,$ROOT/results_psf_sigma_cv_20260904/sigma_1p0/selection/fold2,$ROOT/results_psf_sigma_cv_20260904/sigma_1p0/selection/fold3,$ROOT/results_psf_sigma_cv_20260904/sigma_1p0/selection/fold4
...
summary = {
    ...
    "configuration": {
        ...
        "stages": 12,
        "epochs": 600,
        "member_seeds": [20261671, 20261672, 20261673, 20261674],
    },
