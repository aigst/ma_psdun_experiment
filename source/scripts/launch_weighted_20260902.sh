...
OUT="$ROOT/new_results_20260902_weighted"
mkdir -p "$OUT"
...
run_one 0 weighted_s12_p050 12 0.50
run_one 1 weighted_s08_p050 8 0.50
run_one 2 weighted_s06_p050 6 0.50
run_one 3 weighted_s12_p030 12 0.30
wait
